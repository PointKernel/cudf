...
class device_row_comparator {
 ...
 private:
  ...
  cuda::std::span<detail::dremel_device_view const> _l_dremel;
  cuda::std::span<detail::dremel_device_view const> _r_dremel;
  Nullate _check_nulls;
  cuda::std::optional<cuda::std::span<int const>> _depth;
  cuda::std::optional<cuda::std::span<order const>> _column_order;
